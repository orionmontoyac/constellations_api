...
class TestConstellation:
    ...
    def test_post_create_constellations_ok(self, client, mocker):
        ...
        response = client.post(self.constellations_url, json=data_constellations.NEW_CONSTELLATION_REQUEST)
    ...
    def test_get_constellation_bad_id(self, client):
        response = client.get('{}/{}'.format(self.constellation_url, "bad_id_constellation"))
    ...
    def test_put_constellation_id_ok(self, client, mocker):
        mock = mocker.patch('api.utils.database.ConstellationModel.get_one_constellation')
        mock.return_value = ConstellationModel(**data_constellations.NEW_CONSTELLATION_REQUEST[0])

        mock = mocker.patch('api.utils.database.ConstellationModel.update')
        mock.return_value = data_constellations.ALL_CONSTELLATIONS_RESPONSE[0]

        response = client.put('{}/{}'.format(self.constellation_url, 1),
    ...
    def test_put_constellation_id_not_found(self, client, mocker):
        ...
        response = client.put('{}/{}'.format(self.constellation_url, constellation_id),
                              json=data_constellations.UPDATE_CONSTELLATION_REQUEST)
    ...
    def test_delete_constellation_id_not_found(self, client, mocker):
        ...
        response = client.delete('{}/{}'.format(self.constellation_url, constellation_id))
