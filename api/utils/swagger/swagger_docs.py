...
CONSTELLATIONS_LIST_DOCS = yaml.safe_load(
    Path("api/utils/swagger/constellations_list.yaml").read_text()
)
...
CONSTELLATION_DOCS = yaml.safe_load(
    Path("api/utils/swagger/constellation.yaml").read_text()
)
